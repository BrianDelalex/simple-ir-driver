...
void loop(void) {
  ...
  } else if (IRcompare(numberpulses, CHANNEL_MINUS_SIGNAL,sizeof(CHANNEL_MINUS_SIGNAL)/4)) {
  ...
  } else if (IRcompare(numberpulses, CHANNEL_PLUS_SIGNAL,sizeof(CHANNEL_PLUS_SIGNAL)/4)) {
    Serial.println("CHANNEL + has been pressed.");
  } else if (IRcompare(numberpulses, ZERO_SIGNAL,sizeof(ZERO_SIGNAL)/4)) {
